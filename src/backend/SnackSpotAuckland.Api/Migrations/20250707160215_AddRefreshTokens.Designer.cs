...
namespace SnackSpotAuckland.Api.Migrations
{
    ...
    [Migration("20250707160215_AddRefreshTokens")]
            ...
            modelBuilder.Entity("SnackSpotAuckland.Api.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(5390),
                            Description = "Cookies, chocolates, and other sweet treats",
                            Name = "Sweet Snacks",
                            UpdatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(5390)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(5990),
                            Description = "Chips, crackers, and salty snacks",
                            Name = "Savory Snacks",
                            UpdatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(5990)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(6000),
                            Description = "Nuts, fruits, and nutritious options",
                            Name = "Healthy Snacks",
                            UpdatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(6000)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(6010),
                            Description = "Plant-based snack options",
                            Name = "Vegan Snacks",
                            UpdatedAt = new DateTime(2025, 7, 7, 16, 2, 14, 854, DateTimeKind.Utc).AddTicks(6010)
                        });
                });
